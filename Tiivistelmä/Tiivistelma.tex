%%
% HELSINGIN YLIOPISTON  opinn�ytteisiin liitett�v�n tiivistelm�sivun
% LaTeX2e-kielinen  kaavakem��rittely.
%
% Laatinut:  Greger Linden
%
% Modif. :   Juha Korpi   (tiivistelm�teksti parbox-m��rittelyn avulla)
%
% Modif. :   Tiina Niklander  (muunnos SLaTeX -> LaTeX)
%
% Modif  :   Tapio Lehtonen (CR-luokitukset alareunaan)
%                           (englanninkieliset kent�nnimet 18041994)
...
%
% Seuraaviin k�skyihin t�ydennet��n lomakkeen kenttiin tulevat tiedot.
%
% Tiedekunta/Osasto
%
...
% Laitos
%
%%ESIM: \put(289,784){\makebox(100,8)[l]{Tietojenk�sittelytieteen laitos}}
\put(289,784){\makebox(100,8)[l]{Matematiikan ja tilastotieteen laitos }}
%
% Tekij�    Tekij�n nimi, etunimist� puhuttelunimen� k�ytetty
%
...
% Oppiaine
%
%%ESIM: \put(58,704){\makebox(100,8)[l]{Tietojenk�sittelyoppi}}
\put(58,704){\makebox(100,8)[l]{Matematiikka }}
%
% Ty�n laji     pro gradu -, laudatur- tai lisensiaatinty�
%
\put(58,681){\makebox(100,8)[l]{Pro gradu -tutkielma}}
%
% Aika      Ty�n j�tt�kuukausi ja -vuosi
%
...
%%Tarvittaessa teksti� tiivistelm�laatikon alareunaan:
%%Esimerkiksi luokitustiedot tms.
\put(58,210){\parbox[t]{5.95in}{

}}
%%%%%%%%Seuraaviin kohtiin ei  tarvitse tehd� muutoksia
%
% iso kehys
%
